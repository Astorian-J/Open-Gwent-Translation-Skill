...
| 2026-09-01 | Roche 双卡歧义 + ambiguous_names.md 全表重建 | 罗契登记歧义组（Vernon Roche=弗农·罗契 NR 2/9 不忠间谍，GN 北方核心 / Roche: Merciless=罗契：冷酷之心 NR 4/12 直伤+蓝衣铁卫）；全表对 1381 卡库逐字对齐（48→63 组：26 未动/16 同键修复/21 新键/6 旧键退役），清除 34 行幽灵卡名（33 唯一名）；health_check 新增逐字一致+双解析器对账+线索阵营词不变量防再漂移 | 官方 | BC35/VK 案实锤：英文帖把弗农·罗契写成 Roche: Merciless，术语门禁只查一致性不查事实，一致地错；裸 Roche 此前静默漏提取（无锁无歧义提示），模型凭名气先验默认弗农·罗契。歧义登记后：裸名触发消歧（pack 带双卡线索）、译文裸写「罗契」被门禁拦并给出候选全名。遗留诚实边界：源帖自己认错卡仍防不住（以卡牌图为权威源，见 bc_data 铁律） |
