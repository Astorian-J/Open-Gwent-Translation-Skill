...
| 2026-08-29 | Saov | 鹿灵（Saov Ainmhi'dh 的聊天缩写），登记进 competitive_terms 缩写列 | 官方 | ImT 术语按整词匹配只登记了全名，缩写 Saov 无注入被音译成「萨夫」（2026-08-29 Steam 群聊实测，本地 Hy-MT2-1.8B 与云端引擎同病）；登记缩写走 glossary 注入修复，同 GN（2026-07-29）先例 |
