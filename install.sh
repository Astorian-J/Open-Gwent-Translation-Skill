...
# Deploy flash skill (live-chat fastest tier; single reply, no scripts, no machine gate)
...
echo "  Flash skill: $FLASH_DIR (for live chat / fastest, in-turn self-check, no machine gate)"
echo ""
